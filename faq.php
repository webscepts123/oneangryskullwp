        ...
        <section>
            ...
            <div class="about">
                ...
                <div class="container">
                    ...
                    <div class="text">
                        <p>This Privacy Policy describes how oneangryskull.myshopify.com (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.</p>
                        <h4>Contact</h4>
                        <p>
                            After reviewing this policy, if you have additional questions, want more information about our privacy practices, or would like to make a complaint, please contact us by e-mail at info@oneangryskull.com or by mail using the details provided below:
<br>
United States
                        </p>
               ...
               <li>Personal Information collected: version of web browser, IP address, time zone, cookie information, what sites or products you view, search terms, and how you interact with the Site [ADD OR SUBTRACT ANY OTHER PERSONAL INFORMATION COLLECTED].</li>
                ...
                <ul type="disk">
                    ...
                    <li>
                        ...
                        <li>Personal Information collected: [ADD ANY MODIFICATIONS TO THE INFORMATION LISTED ABOVE OR ADDITIONAL INFORMATION AS NEED.]</li>
